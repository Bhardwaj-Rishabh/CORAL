...
from trainer_module import CustomTrainer, CustomTrainer_setup2, CustomLlamaForCausalLM
...
def train():
    ...
    eval_dataset.make_contrastive_data(eval_dataset_pos, eval_dataset_nut)
